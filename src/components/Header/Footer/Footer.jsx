...
const Footer = () => {
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-[#727272] text-white p-10">
        <nav>
      ...
      <footer className="footer bg-[#727272] text-white  border-gray-800 border-1 px-10 py-4">
        <aside className="grid-flow-col items-center">
          <svg width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" className="fill-current text-primary">
            <path d="M12 2L3.5 6.5v11L12 22l8.5-4.5v-11L12 2zM12 4.5l6.5 3.5v8L12 20l-6.5-4v-8L12 4.5z"></path>
          </svg>
          <p><span className="text-xl font-bold">BOIPOKA</span> <br />A World of Books at Your Fingertips 📚</p>
        </aside>
